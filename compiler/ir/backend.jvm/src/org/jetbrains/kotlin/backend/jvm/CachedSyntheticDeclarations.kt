...
open class CachedSyntheticDeclarations<Context : BackendContext>(protected val context: Context) {
    ...
    /**
     * The modality of the generated function accessor.
     */
    ...
    /**
     * For function accessors, the part of the accessor name that corresponds to the name of [function].
     */
    protected open fun mapFunctionName(function: IrSimpleFunction): String = function.name.asString()

    /**
     * For function accessors, the suffix that includes some of [function]'s important properties.
     */
    protected open fun functionAccessorSuffix(
        ...
        when {
            ...
            // hence accessed on a supertype. If what is accessed is static, we can point to different
    ...
    /**
     * For field _read_ accessors, the part of the accessor name that corresponds to the name of [field].
     */
    ...
    /**
     * For field _write_ accessors, the part of the accessor name that corresponds to the name of [field].
     */
    ...
    protected open fun fieldAccessorSuffix(field: IrField, superQualifierSymbol: IrClassSymbol?): String = field.run {
        ...
        // supertype. If the field is static, the super class the access is on can be different, and therefore
