...
import org.jetbrains.kotlin.fir.analysis.jvm.checkers.expression.FirJvmModuleAccessibilityCheckingProcedure
...
object FirJvmModuleAccessibilityTypeChecker : FirTypeRefChecker(MppCheckerKind.Common) {
    override fun check(typeRef: FirTypeRef, context: CheckerContext, reporter: DiagnosticReporter) {
        ...
        FirJvmModuleAccessibilityCheckingProcedure.checkJvmModuleAccess(context, classSymbol, typeRef, reporter)
    }
}
