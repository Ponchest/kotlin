...
object FirExhaustiveWhenChecker : FirWhenExpressionChecker(MppCheckerKind.Common) {
    ...
    fun reportEmptyThenInExpression(whenExpression: FirWhenExpression, context: CheckerContext, reporter: DiagnosticReporter): Boolean {
        val source = whenExpression.source ?: return false
