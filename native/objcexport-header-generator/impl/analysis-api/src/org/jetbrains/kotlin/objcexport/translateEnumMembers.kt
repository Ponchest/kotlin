...
private fun KtClassOrObjectSymbol.getEnumValuesMethod(): ObjCMethod {
    ...
    return ObjCMethod(
        ...
        returnType = valuesFunctionSymbol?.returnType?.translateToObjCReferenceType() ?: ObjCIdType, //TODO: add proper type
...
private fun KtClassOrObjectSymbol.getEnumEntriesProperty(): ObjCProperty {
    ...
    return ObjCProperty(
        name = "entries",
        comment = null,
        type = entriesSymbol?.returnType?.translateToObjCReferenceType() ?: ObjCIdType, //TODO: add proper type
        propertyAttributes = listOf("class", "readonly"),
