...
private class KtObjCExportHeaderGenerator {
    ...
    context(KtAnalysisSession, KtObjCExportSession)
    private fun translateClassOrObjectSymbol(symbol: KtClassOrObjectSymbol) {/* No classId, no stubs ¯\_(ツ)_/¯ */
        ...
        2) Super interface / superclass symbol export stabs (result of translation) have to be present in the stubs list before the
        original stub
         */
