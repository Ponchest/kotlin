...
class JvmAbiCommandLineProcessor : CommandLineProcessor {
    companion object {
        ...
        val REMOVE_INTERNAL_DECLARATIONS_OPTION: CliOption =
            CliOption(
                "removeInternalDeclarations",
                "true/false",
                "Remove internal declarations from from ABI. False by default due to backwards compatibility. If enabled, " +
    ...
    override val pluginOptions: Collection<CliOption>
        get() = listOf(
            ...
            REMOVE_INTERNAL_DECLARATIONS_OPTION,
        )
    ...
    override fun processOption(option: AbstractCliOption, value: String, configuration: CompilerConfiguration) {
        when (option) {
            ...
            REMOVE_INTERNAL_DECLARATIONS_OPTION -> configuration.put(
                JvmAbiConfigurationKeys.REMOVE_INTERNAL_DECLARATIONS,
                value == "true"
            )
